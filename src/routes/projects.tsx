...
const projects = [
  { image: media.bathroom, alt: "Minimal seamless bathroom finish", title: "The seamless suite", type: "Cementitious finish", detail: "A restrained palette flows continuously from wall to floor, paired with architectural black fittings and concealed lighting." },
  { image: media.commercial, alt: "Commercial room with concrete panels and wood floor", title: "Workplace rhythm", type: "Commercial interior", detail: "Warm wood flooring balances precise concrete-effect wall panels for a polished, hard-wearing workplace." },
  { image: media.wall, alt: "Hand-finished grey statement wall", title: "Silver movement", type: "Decorative wall", detail: "A hand-applied metallic finish gives this feature wall subtle movement, depth and a quietly luxurious presence." },
];
